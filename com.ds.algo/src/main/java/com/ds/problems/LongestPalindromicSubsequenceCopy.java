...
public class LongestPalindromicSubsequenceCopy {
	...
	public static void main(String[] args) {
		...
		LongestPalindromicSubsequenceCopy editProblem = new LongestPalindromicSubsequenceCopy();
		String one = "LongestPalindromicSubsequence";

		System.out.println("Output---" + editProblem.findPalindrome(one));
